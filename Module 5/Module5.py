...
min_lista = []
while True:
    name=input("Skriv in ett namn (skriv 'avsluta' för att avsluta och skriv 'Ta bort' för att ta bort) ")
...
namn1 = input("skriv in det första namnet ")
